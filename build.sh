...
function build {
    ...
    cp -v script/entrypoint.sh        $1/build
    cp -v script/build/snort.sh       $1/build
    cp -v script/build/snort-extra.sh $1/build
    ...
    cp -v script/keep-open.sh       $1/install
    cp -v script/entrypoint.sh      $1/install
